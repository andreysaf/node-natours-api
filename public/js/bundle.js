...
var stripe = Stripe('pk_test_51Hb6v7ByMnCPpthAHyburrtb52tf1ft5TNVDnFOR3qKQT9Uv1QcWpzVHHN8xEPZwQxNj3LSPbAs9le7N4niIn6Lp000O8oqIH5');
...
exports.updatePassword = exports.updateNameAndEmail = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Information updated');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1000);
            }
...
exports.updateNameAndEmail = updateNameAndEmail;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5kcmV5c2FmIiwiYSI6ImNrZnU5NnQ3czBoMDYydXM5bHQ5eHNzbTkifQ.NjBluBnts4BNfvf690OZmQ';
...
var accountFormPass = document.querySelector('.form-user-settings');
...
if (accountFormPass) {
  accountFormPass.addEventListener('submit', function (e) {
    e.preventDefault();
